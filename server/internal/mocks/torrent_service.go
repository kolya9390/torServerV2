...
func (m *MockSettingsService) GetStoragePreferences() map[string]interface{} {
	args := m.Called()
	return args.Get(0).(map[string]interface{})
}

func (m *MockSettingsService) SetStoragePreferences(prefs map[string]interface{}) error {
	args := m.Called(prefs)
	return args.Error(0)
}
