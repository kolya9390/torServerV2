...
var copyRules = []fieldCopyRule{
	...
	{
		shouldCopy: func(p BTSets, _ int64) bool { return p.MaxUniquePlaybackTorrents > 0 },
		apply:      func(dst *BTSets, p BTSets) { dst.MaxUniquePlaybackTorrents = p.MaxUniquePlaybackTorrents },
	},
	{
...
func applyCoreProfileOverrides(dst, src *BTSets) {
	...
	if src.MaxUniquePlaybackTorrents > 0 {
		dst.MaxUniquePlaybackTorrents = src.MaxUniquePlaybackTorrents
	}
