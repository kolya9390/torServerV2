...
Текущий канал TorrServerV2 - beta. Точную следующую версию определяют актуальные release notes и `CHANGELOG.md`;
опубликованные prerelease-теги не переиспользуются и не перемещаются.
